...
export const en: Record<string, string> = {
  ...
  'threadUrlModal.title': 'New thread',
  'threadUrlModal.urlLabel': 'URL',
  'threadUrlModal.placeholder': 'https://example.com',
  'threadUrlModal.submit': 'Add',
  'threadUrl.validation.required': 'Enter a URL.',
  'threadUrl.validation.invalid': 'Enter a valid URL.',
  'threads.add.success.title': 'Thread added',
  'threads.add.success.message': 'The thread was saved on this device.',
  'threads.add.noAccount.title': 'No account',
  'threads.add.noAccount.message': 'Add an account in Settings before creating a thread.',
  ...
  'messageForm.replyTextPlaceholder': 'Write reply',
  'a11y.menu': 'Menu',
  ...
  'account.add.success.title': 'Account created',
  'account.add.success.message': 'The account was saved on this device.',
  'account.add.error.title': 'Could not create account',
