  ...
  migrations: [
    ...
    },
    {
      ...
      steps: [
        ...
        unsafeExecuteSql(
          "UPDATE messages SET is_outgoing = 0 WHERE is_outgoing IS NULL;",
        ),
    ...
    },
    {
      toVersion: 11,
      steps: [
        unsafeExecuteSql('ALTER TABLE messages ADD COLUMN "status" TEXT;'),
        unsafeExecuteSql(
    ...
    },
    {
      ...
      steps: [
        ...
        unsafeExecuteSql("UPDATE threads SET menu = '{}' WHERE menu IS NULL;"),
        addColumns({
          table: "messages",
    ...
    {
      toVersion: 17,
      steps: [unsafeExecuteSql("SELECT 1;")],
    },
  ],
});
