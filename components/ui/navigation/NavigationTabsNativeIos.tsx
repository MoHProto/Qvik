...
/**
 * Native iOS UITabBar via `NativeTabs` (not wired by default).
 * To use: point `NavigationTabs.ios.tsx` at this module instead of `NavigationTabsJs`.
 */
export default function NavigationTabsNativeIos() {
